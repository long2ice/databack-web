<template>
  <div class="flex flex-col items-center border-r">
    <ul class="menu bg-base-100" :class="{
      'w-fit': sidebar.close,
      'w-56': !sidebar.close
    }">
      <li>
      ...
      <li>
        <router-link to="/datasource" :class="{
    ...
    <div class="mt-auto flex w-full cursor-pointer justify-center bg-base-300 p-4"
      @click="sidebar.close = !sidebar.close">
      <GlCollapseLeft class="text-xl" :class="{
