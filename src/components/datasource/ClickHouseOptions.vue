<template>
  ...
  <div class="form-control">
    ...
    <textarea
      ...
      :placeholder="$t('clickhouse_other_options_placeholder')"
    ></textarea>
    <label class="label">
      <span class="label-text-alt">
        {{ $t('clickhouse_other_options_tips') }}
        <a
          class="link-primary link"
          href="https://github.com/AlexAkulov/clickhouse-backup"
          target="_blank"
          >https://github.com/AlexAkulov/clickhouse-backup</a
        >
      </span>
    </label>
  </div>
...
port.value = defaultOptions['--port'] || '9000'
username.value = defaultOptions['--user'] || 'default'
